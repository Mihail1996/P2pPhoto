    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (SimWifiP2pBroadcast.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == SimWifiP2pBroadcast.WIFI_P2P_STATE_ENABLED) {
                ...
                /*Toast.makeText(mFragment, "WiFi Direct disabled",
                        Toast.LENGTH_SHORT).show();*/
            }
            ...
            ginfo.print();
            LoggerFactory.log(this.getClass().getSimpleName() + ": Membership Changed :" + ginfo.getDeviceName());
            ...
            SimWifiP2pInfo ginfo = (SimWifiP2pInfo) intent.getSerializableExtra(
                    SimWifiP2pBroadcast.EXTRA_GROUP_INFO);
            LoggerFactory.log(this.getClass().getSimpleName() + ": Ownership Changed :" + ginfo.getDeviceName());
            ginfo.print();
