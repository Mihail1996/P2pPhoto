...
public class AddUserToAlbumTask extends AsyncTask<Void, String, String> {
    ...
    public AddUserToAlbumTask(String username, String albumName, SharedPreferences sharedPreferences, Callback callback) {
    ...
    protected String doInBackground(Void... args) {
        ...
        try {
            Response<String> response = service.addUserToAlbum(sharedPreferences.getString("cookie", null), username, albumName).execute();
