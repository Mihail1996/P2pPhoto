...
public class ListWifiAlbumsTask extends AsyncTask<String, Void, List<String>> {
    private static final String TAG = ListWifiAlbumsTask.class.getName();
    ...
    public ListWifiAlbumsTask(Callback callback, SharedPreferences sharedPreferences) {
        mCallback = callback;
    ...
    protected List<String> doInBackground(String... strings) {
        ...
        Call<ArrayList<String>> call = service.getUserWifiAlbums(sharedPreferences.getString("cookie", null));
        try {
