...
public class CreateWifiAlbumTask extends AsyncTask<String, Void, Integer> {
    private static final String TAG = CreateWifiAlbumTask.class.getName();
    ...
    public CreateWifiAlbumTask(Callback callback, SharedPreferences sharedPreferences) {
        mCallback = callback;
    ...
    protected Integer doInBackground(String... strings) {
        ...
        try {
            Response<Void> response = service.createWifiAlbum(strings[0], sharedPreferences.getString("cookie", null)).execute();
